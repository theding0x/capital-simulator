...
| Ch. 18    | 🔄 In Progress | The Role of Money-Capital in Reproduction — MoneySupplyApportionment, DepartmentMoneyReserve, CapitalDepartment, CirculatingMoneyMass, WageRotationFund, InterDepartmentSettlement | simulation-engine |
