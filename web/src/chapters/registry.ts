...
export const CHAPTERS: ChapterDef[] = [
  ...
  { id: "v3-ch24", volume: 3, number: 24, title: "Externalisation / Fetish Capital",                          part: "Part V — Division of Profit into Interest and Profit of Enterprise", circuitNode: ["M", "M-prime"],                  status: "done"    },
