...
const QUOTES: Partial<Record<string, string>> = {
  ...
  "v1-ch26": "Capital is not a thing, but a social relation between persons, established by the instrumentality of things.",
  "v1-ch27": "The spoliation of the Church's property, the fraudulent alienation of the State domains, the robbery of the common lands, the usurpation of feudal and clan property, and its transformation into modern private property under circumstances of reckless terrorism, were just so many idyllic methods of primitive accumulation.",
  "v1-ch28": "The advance of capitalist production develops a working class which by education, tradition, and habit looks upon the requirements of that mode of production as self-evident natural laws.",
  "v1-ch29": "The progressive fall in the value of the precious metals ... lowered wages. A portion of the latter was now added to profits.",
  "v1-ch30": "The expropriation of the agricultural producer, of the peasant, from the soil, is the basis of the whole process. The history of this expropriation, in different countries, assumes different aspects, and runs through its various phases in different orders of succession.",
