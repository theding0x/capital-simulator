// finance-service models the distribution of surplus-value among capitals —
// profit, the average rate of profit, prices of production, rent, interest,
// fictitious capital, and the trinity formula. This is Capital Vol. III
// territory; the service is scaffolded empty in foundation Phase 3 and grows
// per chapter as Vol. III PRs land.
package main
...
import (
	...
	"github.com/theding0x/capital-simulator/services/finance-service/internal/transport/httpapi"
)
