...
type Memory struct {
	...
	productionRelationBases       map[revenue.ProductionRelationBasisID]revenue.ProductionRelationBasis
...
func NewMemory() *Memory {
	return &Memory{
		...
		productionRelationBases:       make(map[revenue.ProductionRelationBasisID]revenue.ProductionRelationBasis),
