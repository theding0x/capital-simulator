...
func TestComputeOrganicComposition_Success(t *testing.T) {
	...
	h := httpapi.New(nil, nil, nil, nil, store.NewMemory(), store.NewMemory(), store.NewMemory(), nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestGetGeneralLawScenario_RoundTrip(t *testing.T) {
	t.Parallel()
	st := store.NewMemory()
	h := httpapi.New(nil, nil, nil, nil, st, st, st, nil, nil, nil, nil, nil, nil, nil, nil, nil)
