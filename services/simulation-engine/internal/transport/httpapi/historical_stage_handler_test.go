...
func TestCreateHistoricalStage_Success(t *testing.T) {
	t.Parallel()
	st := store.NewMemory()
	h := httpapi.New(nil, nil, nil, nil, nil, st, st, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestCreateHistoricalStage_BadRequest_MalformedJSON(t *testing.T) {
	t.Parallel()
	h := httpapi.New(nil, nil, nil, nil, nil, store.NewMemory(), store.NewMemory(), nil, nil, nil, nil, nil, nil, nil, nil)
